...
def process_documents():
    ...
    openai_api_key = "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"
    ...
    llm = ChatOpenAI(model_name=model_name, openai_api_key=openai_api_key, temperature=0.7)  # Adjust the temperature value
